...
<%
    ...
    List<Reserva> reservasPendentesAvaliacao = (List<Reserva>) request.getAttribute("reservasPendentesAvaliacao");
    List<Feedback> feedbacksFeitos = (List<Feedback>) request.getAttribute("feedbacksRealizados");
    ...
    if (reservasPendentesAvaliacao == null) reservasPendentesAvaliacao = new ArrayList<>();
    ...
    if (reservaEspecifica != null) {
        ...
        for (Reserva reserva : reservasPendentesAvaliacao) {
        ...
        // Usar todas as reservas pendentes normalmente
        for (Reserva reserva : reservasPendentesAvaliacao) {
...
<head>
    <meta charset="UTF-8">
    <title>Avaliar Locatários - Dashboard</title>
...
<body>
    <header>
        <h1><i class="fas fa-comment-dots"></i> Minhas Avaliações - Dashboard Locador</h1>
    </header>
    ...
    <div class="container">
        <nav class="nav">
            ...
            <a href="<%=request.getContextPath()%>/FeedbackController?action=pagina-locador"><i class="fas fa-comment-dots"></i> Dar Feedback</a>
        </nav>
        ...
        <div class="feedback-grid">
                ...
                <div class="feedback-content">
                    ...
                    <div class="feedback-details">
                        ...
                        <div class="feedback-actions">
                            <a href="<%=request.getContextPath()%>/FeedbackController?action=fazer-avaliacao-locador&reservaId=<%= reserva.getId_reserv() %>" class="btn btn-primary">
                                <i class="fas fa-star"></i> Avaliar Locatário
                            </a>
                            <a href="<%=request.getContextPath()%>/UsuarioController?action=exibir&cpfCnpj=<%= reserva.getUsuario().getCpfCnpj_user() %>&origem=feedbackLocador" class="btn btn-info">
            ...
            <div class="feedback-card" data-category="realizadas">
                ...
                <div class="feedback-content">
                    ...
                    <div class="feedback-details">
                        ...
                        <div class="detail-row">
                            <i class="fas fa-user"></i>
                            <span>Locatário: <%= feedback.getAvaliado_Usuario().getNomeRazaoSocial_user() %> (<%= feedback.getAvaliado_Usuario().getEmail_user() %>)</span>
                        </div>
                        <div class="detail-row">
                            <i class="fas fa-calendar"></i>
                        ...
                        <div class="qualities-display">
                            ...
                            <% if (feedback.isManutencao_feedb()) { %><span class="quality-tag">Cuidadoso com Manutenção</span><% } %>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="feedback-card" data-category="recebidas">
                ...
                <div class="feedback-content">
                    ...
                    <div class="feedback-details">
                        ...
                        <div class="detail-row">
                            <i class="fas fa-user"></i>
                            <span>Avaliado por: <%= feedback.getAvaliador_Usuario().getNomeRazaoSocial_user() %></span>
                        </div>
                        <div class="detail-row">
                            <i class="fas fa-calendar"></i>
            ...
            <div class="no-data" data-category="realizadas" style="display: none;">
                ...
                <p>Você ainda não avaliou nenhum locatário.</p>
            </div>
            <% } %>
            ...
            <div class="no-data" data-category="recebidas" style="display: none;">
                ...
                <p>Você ainda não recebeu nenhuma avaliação dos seus locatários.</p>
            </div>
            <% } %>
        </div>
